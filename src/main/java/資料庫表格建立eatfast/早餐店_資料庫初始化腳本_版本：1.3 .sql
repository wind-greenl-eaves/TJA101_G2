...
CREATE TABLE meal(
    ...
    status VARCHAR(10) NOT NULL DEFAULT '1' CHECK (status IN ('0', '1')) COMMENT '狀態描述(1:上架, 0:下架)',
    PRIMARY KEY (meal_id),
...
CREATE TABLE store_meal_status (
    ...
    status VARCHAR(10) NOT NULL COMMENT '該門市的此餐點狀態 (1=供應中, 0=已售完)',
