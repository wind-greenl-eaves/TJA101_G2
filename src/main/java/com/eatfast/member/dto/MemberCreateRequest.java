...
/**
 * 【路徑】引入必要的外部類別。 - com.eatfast.common.enums.Gender: 從 common.enums 包引入 Gender
...
public class MemberCreateRequest {
	 ...
	 * 連絡電話。
	 * 支援台灣常見的手機和市話格式：
	 * - 手機：0912345678, 0912-345-678, 0912-342-136, 0987-123-4567, 098-702-696, 098-185-569
	 * - 市話：(02)12345678, 02-12345678, 04-23456789
	 * - 特殊格式：098-xxx-xxx, 09x-xxx-xxx（各種分隔格式）
	 */
